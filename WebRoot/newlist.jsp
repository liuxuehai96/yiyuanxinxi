	...
	<body>
		<div id="container">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 bcid-cat">医院动态</div>
						<div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='javascript:;'>主页</a> > <a href='javascript:;'>医院动态</a> > </span></div>
					</div>
				</div>
			</div>
						...
						<div class="main col-md-9 inner-left" role="main">
							...
							<c:forEach items="${list }" var="n">
								<div class="blog-article hentry format-image">
									<figure>
										<a class="swipebox-x" href="showNew.do?id=${n.id }"> <img class="img-responsive" alt="${n.name }" src="./upload/${n.img }" /> </a>
									</figure>
									<div class="entry-summary post-summary">
										<header class="entry-header">
											<h2 class="entry-title post-title"> <a href="showNew.do?id=${n.id }" title="${n.name }">${n.name }</a> </h2>
										</header>
										<div class="entry-meta post-meta">
											<ul>
												...
												<li class="tags">
													<a href="javascript:;">医院动态</a>
												</li>
												<li class="byline author vcard">by
													<a href="showNew.do?id=${n.id }" class="fn">admin</a>
												</li>
											</ul>
										</div>
										...
										<a href="showNew.do?id=${n.id }" class="read-more-link">查看详细</a>
									</div>
								</div>
								</c:forEach>
						...
						<aside class="sidebar col-md-3 inner-right" role="complementary">
							<section class="widget side-search">
								...
								<form class="searchform" id="searchform" name="formsearch" method="post" action="searchNews.do">
									...
									<div class="sform-div">
										<input type="text"  name="name" placeholder="输入医院动态名称" id="s" />
