				...
				<div class="row">
					<div class="main col-md-9 inner-left" role="main">
						<div class="about-page-wrap">
							<div id="contact-wrap">
								<h3 class="msg-title">修改个人信息</h3>
								<form class="add-msg-form" action="addShowInfo.do" onsubmit="return check();"  method="post"><!-- enctype="multipart/form-data" -->
									<div class="row">
										<div class="cf-column col-md-12"> 
										<label>用户名：</label>
											<input id="username" type="text" value="${user.uname }" placeholder="登录名" readonly="readonly" onblur="return checkuname00()" validate="minlength:2, maxlength:50, required:true" />
											<input type="hidden" name="id" value="${user.id }">
											<span id='checku' class="spanInit" ></span>
										</div>
										<div class="cf-column col-md-12"> 
										<label>姓名：</label>
											<input name="tname" value="${user.tname }"  type="text" placeholder="真实姓名" onblur="return checkuname2()"   validate="minlength:2, maxlength:50, required:true" />
											<span id='checku2' class="spanInit" ></span>
										</div>
										
										<div class="cf-column col-md-12">
										<label>密码：</label>
											<input name="pwd" id="txtPwd" type="password" value="${user.pwd }" placeholder="密码"  onblur="return checkpwd()" validate="maxlength:40, required:true, email:true" />
											<span id='prompt_pwd'  class="spanInit" ></span>
										</div>
										<div class="cf-column col-md-12">
											<label>年龄：</label>
												<input name="age" id="age" type="text" placeholder="请输入年龄" required="required"  value="${user.age }" />
										...
										<div class="cf-column col-md-12">
										<label>电话：</label>
											<input name="tel" id="txtPhone" value="${user.tel }" type="text" placeholder="电话/手机"  id="txtPhone" onblur="return checktel()" validate="minlength:6,maxlength:40, required:true" />
											<span id='prompt_phone' class="spanInit" ></span>
										</div>
										
										<div class="cf-column col-md-12">
										<label>家庭住址：</label>
											<input name="address" value="${user.address }" id="address" type="text" placeholder="地址" validate="minlength:6,maxlength:40, required:true" />
										</div>
										<div class="cf-column col-md-12">
											<label>过敏说明：</label>
												<input name="guoming" id="guoming" type="text" placeholder="过敏说明" value="${user.guoming }" />
											</div>
											<div class="cf-column col-md-12">
											<label>既往史：</label>
											<textarea rows="" cols="" style="with:100%;height:10%" name="note">${user.note }
											</textarea>
											</div>
