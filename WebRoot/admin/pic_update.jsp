...
<body >
 <article class="page-container">
	 <form class="form"  action="updatePic.do"  method="post" enctype="multipart/form-data"  ><!-- enctype="multipart/form-data" -->
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="hidden"  value="${pic.id }"  name="id" readonly="readonly">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="请输入器官名称" value="${pic.name }" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>器官类型：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="请输入类型"  value="${pic.ctype }" name="ctype">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>切面：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="请输入切面" value="${pic.qiemian }" name="qiemian">
			</div>
		</div>
		<div class="row cl" >
			<label class="form-label col-xs-4 col-sm-2">图片上传：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<img alt="" src="./upload/${pic.img }" width="50px" height="50px;">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
			<textarea id="editor_id" id="note" name="note" style="width:600px;height:400px;" >${pic.note}</textarea>
