...
<body>
<form method="post" action="orderList_lsSearch.do" id="listform">
    ...
    <table class="table table-hover text-center">
        ...
        <tr>
         ...
         <td>${o.status}</td>
          <td><div class="button-group" > 
            <a class="button border-main" href="liShi.do?id=${o.id }"><span class="icon-edit"></span>查看</a> 
     ...
     <c:if test="${sessionScope.p==1 }">
		<td colspan="15"> <c:if test="${page.page>1}">
              <a href="forderList_ls.do?page=1" >首页</a>
             <a href="forderList_ls.do?page=${page.page-1 }"> 上一页</a> 
             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="forderList_ls.do?page=${page.page+1 }">下一页</a>
			<a href="forderList_ls.do?page=${page.totalPage }">末页</a>
		    </c:if> 
		</td>
	</c:if>
	<c:if test="${sessionScope.p==2 }">
	<td colspan="15"> <c:if test="${page.page>1}">
    <a href="orderList_lsSearch.do?page=1" >首页</a>
    <a href="orderList_lsSearch.do?page=${page.page-1 }"> 上一页</a> 
    </c:if>
    	<c:if test="${page.page<page.totalPage}">
			<a href="orderList_lsSearch.do?page=${page.page+1 }">下一页</a>
			<a href="orderList_lsSearch.do?page=${page.totalPage }">末页</a>
		</c:if> 
		</td>
		</c:if>
      </tr>
