		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<c:forEach items="${list }" var="n" >
				<tr class="text-c">
					...
					<a style="text-decoration:none" class="ml-5" onClick="article_edit1('资讯编辑','article-add.html','10001')" href="doUpdateNews.do?id=${n.id }" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
					<a style="text-decoration:none" class="ml-5" onClick="article_del1(this,'10001')" href="deleteNews.do?id=${n.id }" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
				</c:forEach>
					<tr >
