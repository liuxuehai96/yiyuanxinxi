...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="addUser_ys.do" enctype="multipart/form-data"  >  
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="field">
           <input  type="text" name="xueli" class="input w50"  />
            <div  id='' class="tips"></div>
          </div>
        </div>
       <div class="form-group">
          ...
          <div class="field">
           <input  type="text" name="profession" class="input w50"  />
            <div  id='' class="tips"></div>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="field">
           <input  type="text" name="experience" class="input w50"  />
            <div  id='' class="tips"></div>
          </div>
        </div>
         ...
         <div class="form-group">
          ...
          <div class="field" style="padding-top:8px;"> 
           <textarea rows="10" cols="80" name="note" id="editor_id">
           </textarea>
          </div>
        </div>
      <div class="form-group">
