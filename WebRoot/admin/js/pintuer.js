$(function(){
	...
	$('.banner').each(function(){
		...
		var yiyuanxinxis=e.attr("data-yiyuanxinxi");
		var yiyuanxinxis_s=e.attr("data-small");
		var yiyuanxinxis_m=e.attr("data-middle");
		var yiyuanxinxis_b=e.attr("data-big");
		var num=e.find(".carousel .yiyuanxinxi").length;
		var win=$(window).width();
		var i=1;

		if(interval==null){interval=5};
		if(yiyuanxinxis==null || yiyuanxinxis<1){yiyuanxinxis=1};
		if(yiyuanxinxis_s!=null && win>760){yiyuanxinxis=yiyuanxinxis_s};
		if(yiyuanxinxis_m!=null && win>1000){yiyuanxinxis=yiyuanxinxis_m};
		if(yiyuanxinxis_b!=null && win>1200){yiyuanxinxis=yiyuanxinxis_b};

		var yiyuanxinxiWidth=Math.ceil(e.outerWidth()/yiyuanxinxis);
		var page=Math.ceil(num/yiyuanxinxis);
		e.find(".carousel .yiyuanxinxi").css("width",yiyuanxinxiWidth+ "px");
		e.find(".carousel").css("width",yiyuanxinxiWidth*num + "px");
		
		var carousel=function(){
			i++;
			if(i>page){i=1;}
			$showbanner(e,i,yiyuanxinxis,num);
		};
		...
		if(pointer!=0 && page>1){
			...
			pager.find("li").click(function(){
				$showbanner(e,$(this).val(),yiyuanxinxis,num);
			});
	...
	$showbanner=function(e,i,yiyuanxinxis,num){
		var after=0,leftx=0;
		leftx = - Math.ceil(e.outerWidth()/yiyuanxinxis)*(yiyuanxinxis)*(i-1);
		if(i*yiyuanxinxis > num){after=i*yiyuanxinxis-num;leftx= - Math.ceil(e.outerWidth()/yiyuanxinxis)*(num-yiyuanxinxis);};
