									...
									<form class="add-msg-form" action="login.do"  method="post"><!-- enctype="multipart/form-data" -->
										...
										<div class="row">
											...
											<div class="cf-column col-md-12">
												<input name="uname" id="name" type="text" placeholder="登录名" validate="minlength:2, maxlength:50, required:true" />
											</div>
											<div class="cf-column col-md-12">
												<input name="pwd" id="pwd" type="password" placeholder="密码" validate="maxlength:40, required:true, email:true" />
											</div>
