	...
	<body>
		<div id="container">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 bcid-cat">医疗动态</div>
					...
					<div class="row">
						<div class="main col-md-9 inner-left" role="main">
							<div class="blog-post blog-post-wrap">
								...
								<small class="text-center bp-desc"><i class="fa fa-tag"></i> &nbsp;<a href="javascript:;">医疗动态</a> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-calendar"></i> &nbsp;${news.pubtime }</small>
