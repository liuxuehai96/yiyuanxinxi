			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='javascript:;'>主页</a> > <a href='javascript:;'>添加宠物</a></span></div>
					</div>
				</div>
			</div>
									...
									<form class="add-msg-form" action="addBbs.do"   method="post" ><!-- enctype="multipart/form-data" -->
										<div class="row">
											...
											<div class="cf-column col-md-12 cf-tarea">
												<textarea name="note" id="content" placeholder="留言内容" validate="minlength:2, maxlength:200, required:true"></textarea>
											</div>
